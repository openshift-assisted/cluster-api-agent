...
from core.models import Snapshot, SnapshotMetadata, Commit
...
def test_release_repository_find_all(snapshots_file):
    ...
    assert snapshot.commits[5].repository == "https://github.com/openshift/assisted-installer"
    assert snapshot.commits[6].repository == "https://github.com/openshift/assisted-installer"
...
def test_release_repository_save_new(snapshots_file):
    ...
    new_snapshot = Snapshot(
        ...
        commits=[Commit(repository="https://github.com/new/repo", ref="v1.0.0")],
    )
    ...
    assert len(snapshots[0].commits) == 1
    assert snapshots[0].commits[0].repository == "https://github.com/new/repo"
    assert snapshots[0].commits[0].ref == "v1.0.0"
...
def test_release_repository_update_existing(snapshots_file):
    ...
    updated = Snapshot(metadata=updated_metadata, commits=original.commits)
