...
replace (
	github.com/openshift/assisted-service => github.com/eliorerz/assisted-service v1.0.10-0.20240930092452-c296dbc1cdac
	github.com/openshift/assisted-service/api => github.com/eliorerz/assisted-service/api v0.0.0-20240930092452-c296dbc1cdac
	github.com/openshift/assisted-service/models => github.com/eliorerz/assisted-service/models v0.0.0-20240930092452-c296dbc1cdac
)
